...
const FinalCTA = () => {
  return (
    <section id="contact" className="relative w-full py-[120px] px-6 overflow-hidden bg-black">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center text-center max-w-[800px] mx-auto bg-[#0a0a0a] border border-white/5 rounded-[32px] p-8 md:p-16 glass">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            {/* Phone Number */}
            <a
              href="tel:+918590894407"
              className="text-[#999999] hover:text-white text-[14px] transition-colors"
            >
              or call +91 8590 894 407
            </a>
          </div>
        </div>
      </div>
